...
public:
	...
	*/
	...
	//affiche chaque trajet contenu dans le tableau dynamique au format de sauvegarde
	void AfficherCollectionFormat() const;
	
	//affiche le nomre de trajets demandé contenu dans le tableau dynamique au format de sauvegarde
	void AfficherNbCollectionFormat(int nbTrajets, int premierTrajet) const;
	
	//affiche chaque trajet simple contenu dans le tableau dynamique au format de sauvegarde
	void AfficherTrajetsSimples() const;
	
	//affiche chaque trajet compose contenu dans le tableau dynamique au format de sauvegarde
	void AfficherTrajetsComposes() const;
    
    //affiche les trajets ayant la bonne ville de Depart au format de sauvegarde
    void AfficherTrajetsDepart(char* villeDepart) const;
    
    //affiche les trajets ayant la bonne ville d'arrivee au format de sauvegarde
    void AfficherTrajetsArrivee(char* villeArrivee) const;
    
    //affiche les trajets ayant la bonne ville de Depart et d'arrivee au format de sauvegarde
    void AfficherTrajetsDepartArrivee(char* villeDepart, char* villeArrivee) const;
