...
void Catalogue::AfficherFormat(){
  collectionTrajets->AfficherCollectionFormat();
}

void Catalogue::AfficherTrajetsSimples(){
  collectionTrajets->AfficherTrajetsSimples();
}

void Catalogue::AfficherTrajetsComposes(){
  collectionTrajets->AfficherTrajetsComposes();
}
