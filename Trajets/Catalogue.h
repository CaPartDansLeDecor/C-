...
public:
  ...
  */
  ...
  /*
   Methode d'affichage du catalogue qui permet de le sauvegarder
   */
  void AfficherFormat();
  
  /*
   Methode d'affichage qui permet de sauvegarder les trajets simples
   */
  void AfficherTrajetsSimples();
  
  /*
   Methode d'affichage qui permet de sauvegarder les trajets simples
   */
  void AfficherTrajetsComposes();
